...
```{r biggest-weight, fig.height = 20, message = FALSE}
...
PS If this isn't enough giant pumpkin content for you---and of course it isn't---please enjoy this [YouTube video of elephants crushing pumpkins](https://www.youtube.com/watch?v=IXJg29MNJNM).
